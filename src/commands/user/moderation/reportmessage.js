// commands/user/moderation/reportmessage.js
import { ApplicationCommandType, EmbedBuilder, ModalBuilder, TextInputBuilder, TextInputStyle, ActionRowBuilder } from 'discord.js';
...
export const command = {
    ...
    execute: async (interaction) => {
        try {
            ...
            // Check if user is trying to report a bot
            ...
            // Create report in database using your existing createReport method
